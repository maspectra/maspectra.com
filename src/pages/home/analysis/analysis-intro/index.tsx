      ...
      >
        ...
        >
          ...
          <h2 className={sharedCss.titleH2}>
            <Translate>Data Analysis with all-in-one Platform</Translate>
          </h2>
          <p className={clsx(sharedCss.text, sharedCss.paragraph)}>
            <Translate>
              Consolidate multiple software functionalities into one
              streamlined platform for efficient drug development data
              analysis.
            </Translate>
            <Translate>
              Perform PK/PD and statistical analysis seamlessly from a single
              software.
            </Translate>
            <Translate>
