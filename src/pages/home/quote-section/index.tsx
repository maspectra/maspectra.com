...
const QuoteSection: React.FC = () => {
    ...
    return (
        <div className={quoteSectionCss.quoteSection}>
            <div
                className={quoteSectionCss.quoteBg}
            ...
            <div
                className={quoteSectionCss.quoteContent}
            ...
            >
                <QuoteCard
                    content={
                        <p>
                            <Translate>
                                It is proposed that simulation has a much
                                broader potential to aid in the clinical
                                development, regulatory review,
                                commercialization, and medical application
                                process.
                            </Translate>
                        </p>
                    }
